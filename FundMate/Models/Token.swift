...
struct Token: Identifiable, Equatable {
    ...
    static let mockTokens = [
        ...
        Token(id: UUID(), symbol: "BTC", name: "Bitcoin", iconName: "bitcoinsign.circle.fill", currentPrice: 43000.0),
        Token(id: UUID(), symbol: "USDC", name: "USD Coin", iconName: "dollarsign.circle.fill", currentPrice: 1.0),
        Token(id: UUID(), symbol: "APT", name: "Aptos", iconName: "apt.circle.fill", currentPrice: 8.50)
    ]
} 